...
export default function Create() {
    ...
    // State untuk error custom dari frontend
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        email: '',
        password: '',
        password_confirmation: '', // Tambahan untuk field konfirmasi
    });
    ...
    const submit: FormEventHandler = (e) => {
        ...
        // Jika lolos validasi FE, kosongkan pesan error FE dan lanjut submit
        setFeError('');
                    ...
                    <div className="p-8 md:p-10 grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder="guru@smp51makassar.sch.id"
                                ...
                                {/* Area Password & Konfirmasi Password (Grid Kiri Kanan) */}
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setFeError(''); // Reset error saat mengetik
                                                }}
                                                placeholder="••••••••"
                                            />
                                            <button
                            ...
                            {/* Kotak Info Tambahan */}
                            <div className="bg-slate-50 dark:bg-zinc-800/30 border border-slate-200 dark:border-zinc-700 rounded-xl p-5 mt-6">
                                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                                    <span className="font-black text-slate-900 dark:text-slate-200">Perhatian:</span> Sistem akan otomatis membuatkan akun dengan level akses <span className="uppercase tracking-widest text-[10px] font-black text-blue-600 bg-blue-100 px-1.5 py-0.5 rounded">GURU</span> menggunakan email dan kata sandi di atas. Pastikan data ini diberikan kepada guru yang bersangkutan.
                                </p>
                            </div>
                        </div>
                    </div>
