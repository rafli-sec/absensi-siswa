                ...
                <form onSubmit={handleSubmit} className="space-y-3 relative">
                    ...
                    <div className="fixed bottom-0 left-0 md:left-64 right-0 p-4 bg-white/90 backdrop-blur-xl border-t border-slate-200 z-40">
                        <div className="max-w-4xl mx-auto flex justify-end">
                            <Button 
                                type="submit" 
                                className="w-full md:w-[300px] h-14 rounded-2xl bg-blue-600 hover:bg-blue-700 text-sm font-black uppercase tracking-widest shadow-xl shadow-blue-200 transition-all active:scale-95" 
